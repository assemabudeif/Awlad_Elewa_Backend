...
<head>
    ...
    <title>Awlad Elewa API Documentation</title>
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-GETapi-categories">Display a listing of the resource.</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-categories--category-">
                                <a href="#endpoints-GETapi-categories--category-">Display the specified resource.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-categories--category--products">
                                <a href="#endpoints-GETapi-categories--category--products">GET api/categories/{category}/products</a>
                            </li>
                                ...
                                <a href="#endpoints-GETapi-products--product-">Display the specified resource.</a>
                            </li>
                                ...
                                <a href="#endpoints-GETapi-orders--order-">Display the specified resource.</a>
                            </li>
                                ...
                                <a href="#endpoints-POSTapi-repair-orders">Store a newly created resource in storage.</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-repair-orders--repairOrder-">
                                <a href="#endpoints-GETapi-repair-orders--repairOrder-">Display the specified resource.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-fcm-token">
                                <a href="#endpoints-POSTapi-fcm-token">Update FCM token for authenticated user</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-notifications-toggle">
                                <a href="#endpoints-POSTapi-notifications-toggle">Toggle notifications for authenticated user</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-notifications-settings">
                                <a href="#endpoints-GETapi-notifications-settings">Get user's notification settings</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-notifications">
                                <a href="#endpoints-GETapi-notifications">Get user's notifications history (Laravel notifications)</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-notifications--notification_id--read">
                                <a href="#endpoints-POSTapi-notifications--notification_id--read">Mark notification as read</a>
                            </li>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-categories--category-">Display the specified resource.</h2>
...
<p>The category. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-GETapi-categories--category--products">GET api/categories/{category}/products</h2>
...
<span id="example-requests-GETapi-categories--category--products">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/categories/consequatur/products" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/categories/consequatur/products"
);
...
<span id="example-responses-GETapi-categories--category--products">
    </span>
<span id="execution-results-GETapi-categories--category--products" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-categories--category--products"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-categories--category--products"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-categories--category--products" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-categories--category--products">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-categories--category--products" data-method="GET"
      data-path="api/categories/{category}/products"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-categories--category--products', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-categories--category--products"
                    onclick="tryItOut('GETapi-categories--category--products');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-categories--category--products"
                    onclick="cancelTryOut('GETapi-categories--category--products');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-categories--category--products"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/categories/{category}/products</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-categories--category--products"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-categories--category--products"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="category"                data-endpoint="GETapi-categories--category--products"
               value="consequatur"
               data-component="url">
    <br>
<p>The category. Example: <code>consequatur</code></p>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-products--product-">Display the specified resource.</h2>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="product_id"                data-endpoint="PUTapi-cart--id-"
               value="consequatur"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the products table. Example: <code>consequatur</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="product_id"                data-endpoint="DELETEapi-cart--id-"
               value="consequatur"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the products table. Example: <code>consequatur</code></p>
...
<p>Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-GETapi-orders--order-">Display the specified resource.</h2>
...
<div class="bash-example">
    ...
    --form "estimated_cost=13"\
    --form "final_cost=16"\
    --form "notes=eopfuudtdsufvyvddqamn"\
    --form "photo=@/private/var/folders/cb/l_p237bn28s_z5z4k_h8kyb80000gn/T/phpe2xqy7" \
    --form "audio=@/private/var/folders/cb/l_p237bn28s_z5z4k_h8kyb80000gn/T/phpI9AQSi" </code></pre></div>
...
body.append('estimated_cost', '13');
body.append('final_cost', '16');
body.append('notes', 'eopfuudtdsufvyvddqamn');
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be an image. Must not be greater than 2048 kilobytes. Example: <code>/private/var/folders/cb/l_p237bn28s_z5z4k_h8kyb80000gn/T/phpe2xqy7</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be a file. Must not be greater than 10240 kilobytes. Example: <code>/private/var/folders/cb/l_p237bn28s_z5z4k_h8kyb80000gn/T/phpI9AQSi</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>phone1</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<i>optional</i> &nbsp;
                <input type="number" style="display: none"
               step="any"               name="estimated_cost"                data-endpoint="POSTapi-repair-orders"
               value="13"
               data-component="body">
    <br>
<p>Must be at least 0. Must not be greater than 999999.99. Example: <code>13</code></p>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>final_cost</code></b>&nbsp;&nbsp;
<small>number</small>&nbsp;
<i>optional</i> &nbsp;
                <input type="number" style="display: none"
               step="any"               name="final_cost"                data-endpoint="POSTapi-repair-orders"
               value="16"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="notes"                data-endpoint="POSTapi-repair-orders"
...
<p>Must not be greater than 1000 characters. Example: <code>eopfuudtdsufvyvddqamn</code></p>
                    ...
                    <h2 id="endpoints-GETapi-repair-orders--repairOrder-">Display the specified resource.</h2>
...
<span id="example-requests-GETapi-repair-orders--repairOrder-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-GETapi-repair-orders--repairOrder-">
    </span>
<span id="execution-results-GETapi-repair-orders--repairOrder-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-repair-orders--repairOrder-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-repair-orders--repairOrder-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-repair-orders--repairOrder-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-repair-orders--repairOrder-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-repair-orders--repairOrder-" data-method="GET"
      data-path="api/repair-orders/{repairOrder}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-repair-orders--repairOrder-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-repair-orders--repairOrder-"
                    onclick="tryItOut('GETapi-repair-orders--repairOrder-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-repair-orders--repairOrder-"
                    onclick="cancelTryOut('GETapi-repair-orders--repairOrder-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-repair-orders--repairOrder-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/repair-orders/{repairOrder}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-repair-orders--repairOrder-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-repair-orders--repairOrder-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                        ...
                        <h4 class="fancy-heading-panel"><b>URL Parameters</b></h4>
                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>repairOrder</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="repairOrder"                data-endpoint="GETapi-repair-orders--repairOrder-"
               value="consequatur"
               data-component="url">
    <br>
<p>Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-fcm-token">Update FCM token for authenticated user</h2>
...
<p>Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-notifications-toggle">Toggle notifications for authenticated user</h2>
...
<span id="example-requests-POSTapi-notifications-toggle">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost:8000/api/notifications/toggle" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"enabled\": false
...
<span id="example-responses-POSTapi-notifications-toggle">
</span>
<span id="execution-results-POSTapi-notifications-toggle" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-notifications-toggle"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-notifications-toggle"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-notifications-toggle" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-notifications-toggle">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-notifications-toggle" data-method="POST"
      data-path="api/notifications/toggle"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-notifications-toggle', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-notifications-toggle"
                    onclick="tryItOut('POSTapi-notifications-toggle');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-notifications-toggle"
                    onclick="cancelTryOut('POSTapi-notifications-toggle');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-notifications-toggle"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/notifications/toggle</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-notifications-toggle"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-notifications-toggle"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>boolean</small>&nbsp;
 &nbsp;
                <label data-endpoint="POSTapi-notifications-toggle" style="display: none">
            <input type="radio" name="enabled"
                   value="true"
                   data-endpoint="POSTapi-notifications-toggle"
                   data-component="body"             >
            <code>true</code>
        </label>
        <label data-endpoint="POSTapi-notifications-toggle" style="display: none">
...
<p>Example: <code>false</code></p>
                    ...
                    <h2 id="endpoints-GETapi-notifications-settings">Get user&#039;s notification settings</h2>
...
<span id="example-requests-GETapi-notifications-settings">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-GETapi-notifications-settings">
    </span>
<span id="execution-results-GETapi-notifications-settings" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-notifications-settings"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-notifications-settings"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-notifications-settings" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-notifications-settings">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-notifications-settings" data-method="GET"
      data-path="api/notifications/settings"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-notifications-settings', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-notifications-settings"
                    onclick="tryItOut('GETapi-notifications-settings');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-notifications-settings"
                    onclick="cancelTryOut('GETapi-notifications-settings');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-notifications-settings"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/notifications/settings</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-notifications-settings"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-notifications-settings"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-notifications">Get user&#039;s notifications history (Laravel notifications)</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-notifications--notification_id--read">Mark notification as read</h2>
