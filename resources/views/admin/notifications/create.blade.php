            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">بيانات الإشعار</h3>
                    </div>
                                ...
                                <div class="col-lg-8">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="title" class="form-control @error('title') is-invalid @enderror"
                                            value="{{ old('title') }}" placeholder="أدخل عنوان الإشعار" required>
                                        @error('title')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="body" rows="4" class="form-control @error('body') is-invalid @enderror"
                                            placeholder="أدخل محتوى الإشعار" required>{{ old('body') }}</textarea>
                                        @error('body')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="file" name="image" class="form-control @error('image') is-invalid @enderror"
                                            accept="image/*">
                                        <small class="form-hint">الحد الأقصى: 2MB. الصيغ المدعومة: JPG, PNG, GIF</small>
                                        @error('image')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="mb-3" id="specific-users-section" style="display: none;">
                                        ...
                                        <select name="sent_to[]" class="form-select" multiple size="8">
                                            ...
                                            <option value="{{ $user->id }}" {{ in_array($user->id, old('sent_to', [])) ? 'selected' : '' }}>
